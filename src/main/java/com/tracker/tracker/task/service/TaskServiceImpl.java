...
public class TaskServiceImpl implements TaskService {
    ...
    @Override
    public TaskListResponseVO getTaskPage(String userId, int page, int size, Long categoryId, String taskStaus) {
        ...
        // 현재 페이지 목록 조회
        List<TaskVO> taskList = taskDAO.selectTaskPage(userId, offset, size, categoryId, taskStaus);

        // 전체 개수 조회
        int totalCount = taskDAO.countTasks(userId, categoryId,taskStaus);
